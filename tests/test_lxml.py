...
class TestClassTokens(unittest.TestCase):
    ...
    def test_splits_on_whitespace(self):
        doc = make_doc("<div class='btn-glass-primary active'></div>")
        self.assertEqual(_class_tokens(_first(doc, ".//div")), ["btn-glass-primary", "active"])

    def test_missing_class_is_empty_list(self):
        doc = make_doc("<div></div>")
        self.assertEqual(_class_tokens(_first(doc, ".//div")), [])
...
class TestLoginAndErrorDetection(unittest.TestCase):
    ...
    def test_real_series_page_is_not_an_error(self):
        doc = make_doc("<div id='season-nav'><a data-season-pill='1'>S1</a></div>")
