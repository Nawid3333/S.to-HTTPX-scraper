...
def test_series_page_parse_and_extract(bench):
    ...
    def read_one_series_page():
        ...
        _extract_description_alt_title(doc, title or "")
        _extract_season_links(doc, "moon-knight", "https://s.to")

    assert _extract_season_links(make_doc(html), "moon-knight", "https://s.to"), (
